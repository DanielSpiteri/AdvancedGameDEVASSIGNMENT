	...
	if (IsLocalPlayerController())
	{
		if (SVirtualJoystick::ShouldDisplayTouchInterface())
		{
			...
			if (MobileControlsWidget)
			{
				...
				UE_LOG(LogAdvancedGameDevPRoj, Error, TEXT("Could not spawn mobile controls widget."));
		...
		if (BulletCounterUI)
		{
			...
			UE_LOG(LogAdvancedGameDevPRoj, Error, TEXT("Could not spawn bullet counter widget."));
